...
\begin{figure} [!htb]
	\centering
	\includegraphics[scale=0.45]{K7.png}
...
\begin{figure} [!htb]
	\centering
	\includegraphics[scale=0.70]{K3.png}
...
\begin{figure} [!htb]
	\centering
	\includegraphics[scale=0.60]{K7_ResultTable.png}
...
\begin{figure} [!htb]
	\centering
	\includegraphics[scale=0.60]{K3_ResultTable.png}
...
\begin{figure} [!htb]
	\centering
	\includegraphics[scale=0.25]{TrafficFlow.png}
